all: clean
	...
	gcc -g -DYYMAXDEPTH=20000 -DYYSTACK_RELOCATE -c lex.yy.c -o readcells_parser.lex.o
	gcc -g -DYYMAXDEPTH=20000 -DYYSTACK_RELOCATE -c readcells_parser.y.c -o readcells_parser.y.o
	gcc -g -DYYMAXDEPTH=20000 -DYYSTACK_RELOCATE -o readcells_parser readcells_parser.lex.o readcells_parser.y.o -lfl
